...
public abstract class EntityPredicateMixin {
    ...
    private boolean checkMatchesEntityGroup(EntityTypePredicate instance, Holder<EntityType<?>> type, Operation<Boolean> original, @Local(argsOnly = true) Entity entity) {
